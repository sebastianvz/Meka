...
namespace Kiosko.Helpers
{
    public class Utilities
    {
        ...
        public static KioskoHardware.DoorLocker GetDoorLockerByName(string doorLocker)
        {
            var file = Properties.Settings.Default.DOOR_LOCKER_PATH;
            var doorLockerList = ReadFile<List<KioskoHardware.DoorLocker>>(file);
            var element = doorLockerList.Find(el => el.Name.Equals(doorLocker));
            return element;
        }
